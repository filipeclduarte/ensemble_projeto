...
plt.legend()
plt.grid()
plt.savefig('resultados/Eletric/serie_eletric.png')
plt.show()

# plot de autocorrelacao
plot_acf(treinamento)
plt.savefig('resultados/Eletric/acf_eletric.png')
plt.show()
...
plt.savefig('resultados/Eletric/rmse_treinanmento_eletric.png')
plt.show()
...
ax.set_ylabel('Qtd. neurônios na camada de entrada')
ax.set_xlabel('Qtd. neurônios na camada de escondida')
plt.savefig('resultados/Eletric/rmse_eletric.png')
plt.show()

# analisar configurações
print('Melhores configurações 100 modelos')
print(df_res.sort_values('RMSE'))
df_res.sort_values('RMSE').to_csv('resultados/Eletric/df_res_eletric.csv')
...
# salvar resultados
df_res_ind.sort_values('RMSE').to_csv('resultados/Eletric/df_res_ind_eletric.csv')
...
ax.set_ylabel('Qtd. neurônios na camada de entrada')
ax.set_xlabel('Qtd. neurônios na camada de escondida')
plt.savefig('resultados/Eletric/rmse_best_model_ind_eletric.png')
plt.show()
...
df_res_pool_size.to_csv('resultados/Eletric/df_res_pool_size_eletric.csv')
...
plt.ylabel('RMSE')
plt.savefig('resultados/Eletric/RMSE_pool_size_eletric.png')
plt.show()
...
plt.xlabel('t')
plt.savefig('resultados/Eletric/previsoes_eletric.png')
plt.show()
